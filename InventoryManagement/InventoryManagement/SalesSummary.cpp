...
void SalesSummary :: add(vector<string> addVector)
{
	string rowReceive;
	...
	ssInFile.open("salesSummary.txt");
	if(ssInFile.is_open())
	{
...
string SalesSummary :: search(string columnName, string valueToFind)
{
...
void SalesSummary :: modifyRow(string columnNameToFind, string valueToFind, string columnNameToModify, string valueOfModify){}

void SalesSummary :: deleteRow(string columnName, string valueToFind) {}